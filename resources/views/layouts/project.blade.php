                ...
                @can('index', \App\Models\Asset::class)
                    <li class="treeview{{ Request::is('statuslabels/*') || Request::is('hardware*') ? ' active' : '' }}">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php $status_navs = \App\Models\Statuslabel::where('show_in_nav', '=', 1)
                                ...
                                @foreach ($status_navs as $status_nav)
                                    <li{!! Request::is('statuslabels/' . $status_nav->id) ? ' class="active"' : '' !!}>
                                        <a href="{{ route('statuslabels.show', ['statuslabel' => $status_nav->id]) }}">
                                            ...
                                            {{ $status_nav->name }} ({{ $status_nav->asset_count }})</a>
                    </li>
                    @endforeach
                    @endif
                                                    ...
                                                    <li{!! Request::is('hardware/audit/due') ? ' class="active"' : '' !!}>
                                                        ...
                                                        <li{!! Request::is('hardware/audit/overdue') ? ' class="active"' : '' !!}>
                                                            <a href="{{ route('assets.audit.overdue') }}">
                                                                <i class="fas fa-exclamation-triangle text-red fa-fw"></i>
    ...
    <footer class="main-footer hidden-print" style="display:grid;flex-direction:column;">
        ...
        <div class="1hidden-xs pull-left">
            <div class="pull-left">
                ...
                made with <i class="fas fa-heart" style="color: #a94442; font-size: 10px"
                    aria-hidden="true"></i><span class="sr-only">love</span> by <a
                    href="https://twitter.com/snipeitapp" rel="noopener">@snipeitapp</a>.
            </div>
            <div class="pull-right">
...
<script nonce="{{ csrf_token() }}">
    ...
    clipboard.on('success', function(e) {
        $('.js-copy-link').tooltip('hide').attr('data-original-title', '{{ trans('general.copied') }}')
            .tooltip('show');
    });
